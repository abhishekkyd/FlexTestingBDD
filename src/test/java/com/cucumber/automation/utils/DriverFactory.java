...
public class DriverFactory {
	...
	public static String actualMenuBarImage = propObj
			.returnPropVal("actualMenuBarImage");
	public static String expectedMenuBarImage = propObj
			.returnPropVal("expectedMenuBarImage");
	public static String diffMenuBarImage = propObj
			.returnPropVal("diffMenuBarImage");
	...
	public void appiumDriverandroid() throws MalformedURLException {
		...
		//capabilities.setCapability("appActivity",	"com.xebia.eventsapp.HomePageActivity");
	...
	public void appiumDriverandroidDevice() throws MalformedURLException {
		...
		capabilities.setCapability("app", app.getAbsolutePath());
		capabilities.setCapability("appPackage", "com.xebia.eventsapp");
		driver = new AppiumDriver(new URL("http://127.0.0.1:9515/wd/hub"),
				capabilities);

		waitVar = new WebDriverWait(driver, 90);
	}
	
	public void appiumDriverandroidDeviceChicago() throws MalformedURLException {

		// set up appium
		final File classpathRoot = new File(System.getProperty("user.dir"));
		final File appDir = new File(classpathRoot, "src/test/resources/apps");
		final File app = new File(appDir, "Chicago Tribune_com.apptivateme.next.ct_3.0_29.apk");
		...
		capabilities.setCapability("appActivity", "com.tribune.universalnews.MainActivity");
		driver = new AppiumDriver(new URL("http://127.0.0.1:4723/wd/hub"),
				capabilities);
	    
		waitVar = new WebDriverWait(driver, 30);
		browserId = "androidDevice";
	}
	
	public void appiumDriverandroidDeviceChicagoWeb() throws MalformedURLException {
		
		DesiredCapabilities capabilities = new DesiredCapabilities();
		/*capabilities.setCapability(MobileCapabilityType.PLATFORM_NAME, "Android");
		capabilities.setCapability(MobileCapabilityType.PLATFORM_VERSION, "4.4");
		capabilities.setCapability(MobileCapabilityType.DEVICE_NAME, "Xebia(Galaxy S4)");
        ...
        capabilities.setCapability("appActivity", ".com.google.android.app.chrome.Mains");
	 ...
	 * "C:\\Program Files\\ImageMagick-6.8.9-Q16\\compare.exe", "-metric", "AE",
	 * "-fuzz", "1%",
	 ...
	 * InputStreamReader( p.getErrorStream())); String line = reader.readLine();
	 * while (line != null) { System.out.println("$$$$$$$$$$$$$$$$$$$$$" +
	 * line); if (line.contains("compare.exe: image widths or heights differ"))
	 * assertFalse("image widths or heights differ", true);; if
	 * (!line.equalsIgnoreCase("0"))
	 * assertFalse("There are diff(s) in images. Check output file.", true);
	 * 
	...
	public void cutRequiredImage() throws IOException {
		...
		File imageDir = new File(System.getProperty("user.dir"),
				"src/test/resources/images/");
		...
		/*
		 * BufferedImage image = ImageIO.read(f); ByteArrayOutputStream baos =
	...
	public void compareImages() throws IOException, InterruptedException {
		...
		File utilsDir = new File(System.getProperty("user.dir"),
				"src/test/resources/utils/");

		try {
			Process p = Runtime.getRuntime().exec(
					new String[] { "ruby", utilsDir + "\\diff.rb",
							actualMenuBarImage, expectedMenuBarImage,
							diffMenuBarImage });
			...
			while (line != null) {
				...
				if (line.contains("pixels changed:")) {
					if (!line.contains("pixels changed:     0"))
						assertFalse(
								"There is diff in actual and expected images.",
								true);
					;
				}
	...
	public void createHTMLFile() throws IOException {
		...
		htmlBuilder
				.append("<html><head><title>Adda52 Automation Suite</title></html></head>");
		htmlBuilder.append("<body>");
		htmlBuilder.append("adda52.com screenshots in diff sizes");
	...
	/*
	 * public void getScenraio(Scenario scenario2) { scenario = scenario2;
	 * 
	 * }
	 */
